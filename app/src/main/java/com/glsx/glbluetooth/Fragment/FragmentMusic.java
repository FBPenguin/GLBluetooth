package com.glsx.glbluetooth.Fragment;
...
import com.glsx.glbluetooth.A2dpStatus;
...
public class FragmentMusic extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 */
		if (GocsdkCallbackImpl.hfpStatus > 0) {
			try {
	...
	private void initStatus() {
		Log.d("goc","a2dpStatus:"+GocsdkCallbackImpl.a2dpStatus);
		if(GocsdkCallbackImpl.a2dpStatus== A2dpStatus.STREAMING){
	...
	public void onClick(View v) {
		if (GocsdkCallbackImpl.hfpStatus < 3) {
