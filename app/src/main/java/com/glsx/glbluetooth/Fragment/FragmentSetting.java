...
import com.glsx.glbluetooth.View.MyEditText;
...
public class FragmentSetting extends Fragment implements OnClickListener {
	...
	private View initView(View view) {
		...
		et_device_name.setOnFinishComposingListener(new MyEditText.onFinishComposingListener() {
		...
		et_pin_code.setOnFinishComposingListener(new MyEditText.onFinishComposingListener() {
