package com.glsx.glbluetooth.RemoteService;
...
import com.glsx.glbluetooth.Event.A2dpStatusEvent;
import com.glsx.glbluetooth.Event.CurrentNumberEvent;
import com.glsx.glbluetooth.Event.HfpStatusEvent;
import com.glsx.glbluetooth.Event.MusicInfoEvent;
import com.glsx.glbluetooth.Event.MusicPosEvent;
import com.glsx.glbluetooth.Event.PlayStatusEvent;
...
import com.glsx.glbluetooth.HfpStatus;
import com.glsx.glbluetooth.MainActivity;
import com.glsx.glbluetooth.Util.LLog;
import com.glsx.glbluetooth.domain.BlueToothInfo;
import com.glsx.glbluetooth.domain.BlueToothPairedInfo;
import com.glsx.glbluetooth.domain.CallLogInfo;
import com.goodocom.gocsdk.IGocsdkCallback;

import org.greenrobot.eventbus.EventBus;

public class GocsdkCallbackImpl extends IGocsdkCallback.Stub {
    ...
    public void onHfpDisconnected() throws RemoteException {
        ...
        GocsdkCallbackImpl.hfpStatus = 1;
    }
    ...
    public void onHfpConnected() throws RemoteException {
        ...
        GocsdkCallbackImpl.hfpStatus = 3;
    }
    ...
    public void onCallSucceed(String number) throws RemoteException {
        ...
        GocsdkCallbackImpl.hfpStatus = 4;
    }
    ...
    public void onIncoming(String number) throws RemoteException {
        ...
        handler1.sendMessage(handler1.obtainMessage(MainActivity.MSG_COMING,
                number));
        GocsdkCallbackImpl.number = number;
        GocsdkCallbackImpl.hfpStatus = 5;
    }
    ...
    public void onTalking(String number) throws RemoteException {
        ...
        handler.sendMessage(handler.obtainMessage(MainActivity.MSG_TALKING,number));
        GocsdkCallbackImpl.hfpStatus = 6;
    }
    ...
    public void onHfpStatus(int status) throws RemoteException {
        int prevStatus = GocsdkCallbackImpl.hfpStatus;

        GocsdkCallbackImpl.hfpStatus = status;
    ...
    public void onPhoneBook(String name, String number) throws RemoteException {
        ...
        FragmentPhonebookList.Phonebook phonebook = new FragmentPhonebookList.Phonebook();
        phonebook.name = name;
