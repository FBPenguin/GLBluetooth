package com.glsx.glbluetooth.Service;
...
import com.glsx.glbluetooth.Activity.TransparentActivity;
import com.glsx.glbluetooth.Common.Commands;
...
public class CommandParser {
	...
	private void onByte(byte b) {
		LLog.e(TAG,"serialPort data is ="+b);
		if ('\n' == b)
			return;
		if (count >= 1000)
			count = 0;
